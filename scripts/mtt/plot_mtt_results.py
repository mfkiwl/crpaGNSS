...
def plot_2d_position(data: dict, scenario: str, save: bool):
    ...
    # plot receivers
    sns.scatterplot(x=data["x_rcvr"][0, :], y=data["x_rcvr"][1, :], s=150, ax=ax, color="k", label="RECEIVERS")

    # plot estimates
    for i in range(data["x_est"].size):
        if data["x_est"][i].size > 0:
            if i == 0:
                ax.scatter(data["x_est"][i][0, :], data["x_est"][i][1, :], s=30, color="y", marker="x", label="Estimate")
            else:
                ax.scatter(data["x_est"][i][0, :], data["x_est"][i][1, :], s=30, color="y", marker="x", label="_nolabel_")
    ...
    for i in range(data["t_birth"].size):
        ...
        if i == 0:
            sns.lineplot(x=x, y=y, ax=ax, color="r", linewidth=3, label="EMITTERS", estimator=None, sort=False)
        else:
            sns.lineplot(x=x, y=y, ax=ax, color="r", linewidth=3, label="_nolegend_", estimator=None, sort=False)
...
def plot_position_vs_time(data: dict, scenario: str, save: bool):
    ...
    for i in range(data["x_est"].size):
        if data["x_est"][i].size > 0:
            ...
            if i == 0:
                ax[0].scatter(t, data["x_est"][i][0, :], s=30, color="y", marker="x", label="Estimate")
                ax[1].scatter(t, data["x_est"][i][1, :], s=30, color="y", marker="x", label="Estimate")
            else:
                ax[0].scatter(t, data["x_est"][i][0, :], s=30, color="y", marker="x", label="_nolabel_")
                ax[1].scatter(t, data["x_est"][i][1, :], s=30, color="y", marker="x", label="_nolabel_")
    ...
    for i in range(data["t_birth"].size):
        ...
        if i == 0:
            sns.lineplot(x=t, y=x, ax=ax[0], color="r", linewidth=3, label="Truth", estimator=None, sort=False)
            sns.lineplot(x=t, y=y, ax=ax[1], color="r", linewidth=3, label="Truth", estimator=None, sort=False)
        else:
            sns.lineplot(x=t, y=x, ax=ax[0], color="r", linewidth=3, label="_nolegend_", estimator=None, sort=False)
            sns.lineplot(x=t, y=y, ax=ax[1], color="r", linewidth=3, label="_nolegend_", estimator=None, sort=False)
...
def plot_velocity_vs_time(data: dict, scenario: str, save: bool):
    ...
    for i in range(data["x_est"].size):
        if data["x_est"][i].size > 0:
            t = np.repeat(data["time"][i], data["n_est"][i])
            if i == 0:
                ax[0].scatter(t, data["x_est"][i][2, :], s=30, color="y", marker="x", label="Estimate")
                ax[1].scatter(t, data["x_est"][i][3, :], s=30, color="y", marker="x", label="Estimate")
            else:
                ax[0].scatter(t, data["x_est"][i][2, :], s=30, color="y", marker="x", label="_nolabel_")
                ax[1].scatter(t, data["x_est"][i][3, :], s=30, color="y", marker="x", label="_nolabel_")
...
def plot_cardinality_vs_time(data: dict, scenario: str, save: bool):
    ...
    sns.lineplot(x=data["time"], y=data["n_true"], ax=ax, color="r", linewidth=3, label="Truth")
    sns.scatterplot(x=data["time"], y=data["n_est"], ax=ax, s=30, color="y", marker="x", linewidth=2.25, label="Estimate")
    ax.grid(visible=True, which="both", axis="both")
...
def plot_all_meas_vs_time(data: dict, scenario: str, save: bool):
    ...
    for i in range(data["time"].size):
        ...
        if i == 0:
            sns.scatterplot(
                x=t, y=data["y_meas"][i].ravel(), ax=ax, s=30, color="y", marker="x", linewidth=2.25, label="Estimate"
            )
        else:
            sns.scatterplot(
                x=t, y=data["y_meas"][i].ravel(), ax=ax, s=30, color="y", marker="x", linewidth=2.25, label="_nolabel_"
            )
    ...
    for i in range(data["t_birth"].size):
        ...
        t = data["time"][data["t_birth"][i] : data["t_death"][i]]
        if i == 0:
            sns.lineplot(x=t, y=y1, ax=ax, color="r", linewidth=3, label="Truth", estimator=None, sort=False)
        else:
            sns.lineplot(x=t, y=y1, ax=ax, color="r", linewidth=3, label="_nolegend_", estimator=None, sort=False)
        sns.lineplot(x=t, y=y2, ax=ax, color="r", linewidth=3, label="_nolegend_", estimator=None, sort=False)
        sns.lineplot(x=t, y=y3, ax=ax, color="r", linewidth=3, label="_nolegend_", estimator=None, sort=False)
        sns.lineplot(x=t, y=y4, ax=ax, color="r", linewidth=3, label="_nolegend_", estimator=None, sort=False)
...
def plot_mc_results(scenario: str, save: bool):
    ...
    sns.lineplot(x=data["time"], y=data["mean_x"], ax=ax[0], color="k", linewidth=3, label="MC μ")
    sns.lineplot(x=data["time"], y=data["mean_x"] + 3 * data["mc_std_x"], ax=ax[0], color="b", linewidth=3, label="MC 3σ")
    sns.lineplot(x=data["time"], y=data["mean_x"] - 3 * data["mc_std_x"], ax=ax[0], color="b", linewidth=3, label="_nolabel_")
    sns.lineplot(x=data["time"], y=3 * data["an_std_x"], ax=ax[0], color="r", linewidth=3, label="Analytical 3σ")
    sns.lineplot(x=data["time"], y=-3 * data["an_std_x"], ax=ax[0], color="r", linewidth=3, label="_nolabel_")

    sns.lineplot(x=data["time"], y=data["mean_y"], ax=ax[1], color="k", linewidth=3, label="MC μ")
    sns.lineplot(x=data["time"], y=data["mean_y"] + 3 * data["mc_std_y"], ax=ax[1], color="b", linewidth=3, label="MC 3σ")
    sns.lineplot(x=data["time"], y=data["mean_y"] - 3 * data["mc_std_y"], ax=ax[1], color="b", linewidth=3, label="_nolabel_")
    sns.lineplot(x=data["time"], y=3 * data["an_std_y"], ax=ax[1], color="r", linewidth=3, label="Analytical 3σ")
    sns.lineplot(x=data["time"], y=-3 * data["an_std_y"], ax=ax[1], color="r", linewidth=3, label="_nolabel_")
    ...
    sns.lineplot(x=data["time"], y=data["rmse_x"], ax=ax1, color="b", linewidth=3, label="East")
    sns.lineplot(x=data["time"], y=data["rmse_y"], ax=ax1, color="r", linewidth=3, label="North")
    ...
    sns.lineplot(x=data["time"], y=data2["n_true"], ax=ax2, color="r", linewidth=3, label="Truth")
    sns.lineplot(x=data["time"], y=data["mean_n"], ax=ax2, color="b", linewidth=3, label="Estimate")
